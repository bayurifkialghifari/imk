                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-primary btn-sm"
                                                    onclick="update(`{{ $d['id'] }}`, `{{ $d['nomor'] }}`, `{{ $d['jumlah_kursi'] }}`)">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nomor" placeholder="Nomer"
                                        required />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="jumlah_kursi" placeholder="Harga"
                                        required />
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    <script>
        ...
        // Update button click
        let update = (id, nomor, jumlah_kursi) => {
            postType = 'update'
            $('#id').val(id)
        ...
        $(() => {
            ...
            $('#form').submit(ev => {
                ...
                let url = postType == 'create' ?
                    '{{ base_url }}meja/insert' :
                    '{{ base_url }}meja/update';
